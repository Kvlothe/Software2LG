...
public class Customer
{
    ...
    public Customer(String customerName, String division, String address, String firstLevelDivision, String postal, String phoneNum) {
        this.customerName = customerName;
        this.customerCountry = division;
        this.customerAddress = address;
        this.customerCity = firstLevelDivision;
    ...
    public int getCustomerAddressID(){ return addressID; }
